...
public class TestSimpleOomage {
    ...
    public void testHashCodePerfect() {
         ...
         */
        BTree<Integer, Integer> hashSet = new BTree<Integer, Integer>();
        for (int red = 0; red < 256; red += 5) {
            for (int blue = 0; blue < 256; blue += 5) {
                for (int green = 0; green < 256; green += 5) {
                    SimpleOomage oOmage = new SimpleOomage(red, green, blue);
                    assertEquals(null, hashSet.get(oOmage.hashCode()));
                    hashSet.put(oOmage.hashCode(), 0);
                }
            }
        }
    }
